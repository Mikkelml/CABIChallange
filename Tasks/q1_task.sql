...
Berfore this is runed, you need to create the view in task 4.1
*/
...
-- The average time for all won or lost cases is 38 days -> one month and 8 days
SELECT 
    AVG(
        CASE 
...
The max cost for a case is 4700 for case 1050
*/
